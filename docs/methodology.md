...
- **Traders**: Channels — interactive dashboard (real-time), concise daily email reports, and alert notifications. Format/Detail — short actionable summaries, recent change-point chart snippets, confidence scores, and suggested watchlists; high-frequency, trade-oriented detail.
- **Policymakers**: Channels — periodic policy briefs (PDF), executive presentations, and curated dashboard snapshots. Format/Detail — 1–2 page executive summaries with clear implications, scenario comparisons, and uncertainty notes; strategic-level, low-to-medium technical detail, delivered monthly or on request.
- **Energy Firms (producers/refiners/trading desks)**: Channels — detailed technical reports, full dashboard access, and stakeholder workshops. Format/Detail — operational impact estimates, event timelines, model assumptions, and implementation notes; medium-to-high detail for operational planning, delivered weekly/monthly and on-demand for incidents.
- **Analysts & Researchers**: Channels — full technical reports, downloadable datasets, API/notebook access. Format/Detail — complete methodology appendices, reproducible notebooks, and raw/processed data; full technical detail to enable replication and further analysis.
- **Investors / Portfolio Managers**: Channels — executive summaries, investor memos, and dashboard snapshots. Format/Detail — concise risk/return impacts, stress-test scenarios, and hedging considerations; medium detail focused on financial implications and decision-making.
- **Public & Media**: Channels — press releases, blog posts, and visual one-pagers. Format/Detail — plain-language summaries, annotated visuals, and key takeaways; high-level and non-technical.

- **Alerts & Escalation**: High-confidence, time-sensitive change points trigger immediate alerts (email/SMS) to subscribed traders and firm operators; policymaker and executive notifications follow with a short brief and recommended next steps.
- **Ownership & Cadence**: The data science team produces technical deliverables and maintains the dashboard; a communications lead prepares executive briefs and coordinates stakeholder presentations. Regular cadences: daily summaries for traders, weekly/biweekly briefs for firms and analysts, monthly summaries for policymakers, and ad-hoc reports for major events.
